...
import com.dailycode.hotelBooking.exception.InternalServerException;
import com.dailycode.hotelBooking.exception.ResourceNotFoundException;
import com.dailycode.hotelBooking.model.Room;
import com.dailycode.hotelBooking.repository.RoomRepository;
    ...
    public Room updateRoom(Long roomId, String roomType, BigDecimal roomPrice, byte[] photoBytes) {
        ...
        if (photoBytes != null && photoBytes.length > 0) {
            try {
                ...
                throw new InternalServerException("Error update photo");
            }
        }
        return roomRepository.save(room);
    }
